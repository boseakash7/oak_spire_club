...
class _UserHeaderCard extends StatelessWidget {
  const _UserHeaderCard({this.name, this.email});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.tagGoldBorder, width: 1.2),
...
class _SettingsRowCard extends StatelessWidget {
  const _SettingsRowCard({required this.data, required this.onTap});
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: data.destructive
                  ? AppColors.marketTrendDown.withValues(alpha: 0.45)
                  : _kCardBorder,
            ),
            gradient: AppColors.cardSurfaceGradient,
          ),
