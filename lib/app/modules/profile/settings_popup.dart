// Legacy settings popup (card rows + borders). Replaced by [settings_menu_popup.dart].
export 'settings_menu_popup.dart';
...
// Full legacy implementation preserved in git history / uncomment block above.
*/
